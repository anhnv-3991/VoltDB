            ...
            if (VoltDB.getLoadLibVOLTDB()) {
                ...
                try {
                    ...
                    hostLog.info("Successfully loaded native VoltDB library " + libname + ".");
                                 ...
                                 String msg = "UnsatisfiedLinkError: Library doest not exist!!! Path is " +
                                     ...
                                     String msg = "SecurityException. Message = " + e.getMessage() + "\n";
                                     VoltDB.crashLocalVoltDB(msg, false, null);
                 
                                     return false;
                                 } catch (NullPointerException e) {
                                  String msg = "NullPointerException. Message = " + e.getMessage() + "\n";
                                     VoltDB.crashLocalVoltDB(msg, false, null);
